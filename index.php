...
<body>
    ...
    <form action="./endpoint/login.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <!-- <p id= "forgot">Forgot Password?<a  class="switch-form-link" href="http://localhost:84/otp/forgot-password.php">Here.</a></p> -->
                        ...
                        <p>Membuka Hasil ujian <a href="http://localhost:84/otp/dekripsi.php" style="color:black; text-decoration: none;">Here.</a></p>
