...
if (isset($_POST['forgot'])) { // proses saat lupa password
    try {
        ...
        if (!empty($nameExist)) {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Verification Code';
            $mail->Body = 'Your verification code is:  http://localhost:84/otp/verification.php?code=' . $verification_code;
            ...
            header('Location: http://localhost:84/otp/forgot-password.php?message=success');
        } else {
            echo "
            <script>
                alert('User Already Exists');
    ...
    try {
        ...
        if ($codeExist && $codeExist['verification_code'] == $verificationCode) {
            ...
            <script>
                ...
                window.location.href = 'http://localhost:84/otp/verification.php';
            </script>
